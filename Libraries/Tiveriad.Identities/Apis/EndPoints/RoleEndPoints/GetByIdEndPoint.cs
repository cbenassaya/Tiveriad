...
public class GetByIdEndPoint : ControllerBase
{
    ...
    public async Task<ActionResult<RoleReaderModelContract>> HandleAsync([FromRoute] [Required] string id,
        CancellationToken cancellationToken)
    {
        //<-- START CUSTOM CODE-->
        var result = await _mediator.Send(new RoleGetByIdQueryHandlerRequest(id), cancellationToken);
