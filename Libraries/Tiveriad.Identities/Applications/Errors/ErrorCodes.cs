...
public static class ErrorCodes
{
    ...
    public static string Realm_Code_XNotEmptyRule = "Realm_Code_XNotEmptyRule";
    public static string Realm_Code_XMaxLengthRule_Max_24 = "Realm_Code_XMaxLengthRule_Max_24";
    public static string Realm_Code_XUniqueRule = "Realm_Code_XUniqueRule";
    public static string Role_Code_XNotEmptyRule = "Role_Code_XNotEmptyRule";
    public static string Role_Code_XMaxLengthRule_Max_24 = "Role_Code_XMaxLengthRule_Max_24";
    public static string Role_Code_XUniqueRule = "Role_Code_XUniqueRule";
