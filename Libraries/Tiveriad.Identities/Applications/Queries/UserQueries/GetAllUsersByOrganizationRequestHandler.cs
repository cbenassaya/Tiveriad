    ...
    GetAllUsersByOrganizationRequestHandler : IRequestHandler<GetAllUsersByOrganizationRequest, IEnumerable<User>>
{
    ...
    public GetAllUsersByOrganizationRequestHandler(IRepository<Membership, string> membershipRepository)
    {
        _membershipRepository = membershipRepository;
    }

    public Task<IEnumerable<User>> Handle(GetAllUsersByOrganizationRequest request, CancellationToken cancellationToken)
    {
        //<-- START CUSTOM CODE-->
