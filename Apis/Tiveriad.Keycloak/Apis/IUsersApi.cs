...
public interface IUsersApi
{
    ...
    Task<ApiResponse<List<object>>> GetUserGroups (string realm, string id,  bool briefRepresentation = true,  int? first = null,  int? max =  null, string search = null);
