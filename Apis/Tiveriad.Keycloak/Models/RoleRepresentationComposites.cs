...
/// </summary>
[DataContract]
public class RoleRepresentationComposites : IEquatable<RoleRepresentationComposites>, IValidatableObject
{
    /// <summary>
    ...
    public RoleRepresentationComposites(Dictionary<string, object> _client = default, List<string> realm = default)
    {
        _Client = _client;
        Realm = realm;
    }
    ...
    {
        return Equals(input as RoleRepresentationComposites);
    }
