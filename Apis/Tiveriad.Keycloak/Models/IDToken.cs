...
/// </summary>
[DataContract]
public class IDToken : IEquatable<IDToken>, IValidatableObject
{
    /// <summary>
    ///     Defines Category
    /// </summary>
    ...
    public IDToken(string acr = default, AddressClaimSet address = default, string atHash = default,
        long? authTime = default, string azp = default, string birthdate = default, string cHash = default,
        CategoryEnum? category = default, string claimsLocales = default, string email = default,
        ...
        string preferredUsername = default, string profile = default, string sHash = default,
        string sessionState = default, string sid = default, string sub = default, string typ = default,
        long? updatedAt = default, string website = default, string zoneinfo = default)
    {
        Acr = acr;
        Address = address;
        AtHash = atHash;
    ...
    {
        return Equals(input as IDToken);
    }
