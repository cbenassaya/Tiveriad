...
{
    public UserApi(HttpClient httpClient, IKeycloakSessionFactory keycloakSessionFactory) : base(httpClient,
    ...
    public Task<ApiResponse<UserRepresentation>> GetUserByRealmBy(string realm, string id)
    {
        ...
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->GetUserByRealmById");
        // verify the required parameter 'id' is set
        if (id == null)
            throw new ApiException(400, "Missing required parameter 'id' when calling UserApi->GetUserByRealmById");
    ...
    public Task<ApiResponse<List<object>>> GetUserGroups(string realm, string id, bool briefRepresentation = true,
        int? first = null, int? max = null, string search = null)
    {
        // verify the required parameter 'realm' is set
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->GetUserGroups");
        // verify the required parameter 'id' is set
        if (id == null)
            throw new ApiException(400, "Missing required parameter 'id' when calling UserApi->GetUserGroups");
    ...
    /// </param>
    /// <returns>Task of ApiResponse (UserRepresentation)</returns>
    public Task<ApiResponse<List<UserRepresentation>>> GetUsersByRealm(string realm, bool briefRepresentation = true,
        ...
        int? max = null, string? q = null, string search = null, string username = null)
    {
        // verify the required parameter 'realm' is set
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->GetUsersByRealm");
        ...
        return Execute(async (apiClient, token) =>
        {
            var result = await apiClient.GetAsync(builder =>
            {
                builder
                    ...
                    .QueryStringIf(() => emailVerified != null, "emailVerified", emailVerified)
    ...
    public Task<ApiResponse<bool>> PostLogout(string realm, string id)
    {
        // verify the required parameter 'realm' is set
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->PostLogout");
        // verify the required parameter 'id' is set
        if (id == null)
            throw new ApiException(400, "Missing required parameter 'id' when calling UserApi->PostLogout");
    ...
    public Task<ApiResponse<bool>> PostUser(string realm, UserRepresentation body)
    {
        // verify the required parameter 'realm' is set
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->PostUser");
        // verify the required parameter 'realm' is set
        if (body == null)
            throw new ApiException(400, "Missing required parameter 'body' when calling UserApi->PostUser");
    ...
    public Task<ApiResponse<bool>> PutUser(string realm, string id, UserRepresentation body)
    {
        // verify the required parameter 'realm' is set
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->PutUser");
        // verify the required parameter 'id' is set
        if (id == null)
            throw new ApiException(400, "Missing required parameter 'id' when calling UserApi->PutUser");
    ...
    public Task<ApiResponse<bool>> PutUserGroup(string realm, string id, string groupId)
    {
        // verify the required parameter 'realm' is set
        if (realm == null)
            throw new ApiException(400, "Missing required parameter 'realm' when calling UserApi->PutUserGroup");
        // verify the required parameter 'id' is set
        if (id == null)
            throw new ApiException(400, "Missing required parameter 'id' when calling UserApi->PutUserGroup");
        // verify the required parameter 'groupId' is set
        if (groupId == null)
            throw new ApiException(400, "Missing required parameter 'groupId' when calling UserApi->PutUserGroup");
