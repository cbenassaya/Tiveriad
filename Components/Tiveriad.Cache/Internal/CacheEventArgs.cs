...
public enum CacheItemRemovedReason
{
    ...
    /// </summary>
    /// <remarks>
    ///     This will eventually trigger a <see cref="ICacheManager{TCacheValue}.OnRemoveByHandle" /> for the responsible cache
    ///     layer and
...
public sealed class CacheItemRemovedEventArgs : EventArgs
{
    ...
    public CacheItemRemovedEventArgs(string key, string region, CacheItemRemovedReason reason, object value,
        int level = 0)
    {
...
public sealed class CacheActionEventArgs : EventArgs
{
    ...
    /// <param name="region">The region.</param>
    /// <param name="origin">
    ///     The origin the event ocured. If remote, the event got triggered by the backplane and was not
    ///     actually excecuted locally.
    /// </param>
    /// <exception cref="System.ArgumentNullException">If key is null.</exception>
