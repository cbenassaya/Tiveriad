...
internal static class CacheReflectionHelper
{
    ...
    internal static ICacheSerializer CreateSerializer(ICacheManagerConfiguration configuration,
    ...
    internal static CacheBackplane CreateBackplane(ICacheManagerConfiguration configuration,
        ILoggerFactory loggerFactory)
    {
        NotNull(configuration, nameof(configuration));
        NotNull(loggerFactory, nameof(loggerFactory));
    ...
    internal static ICollection<BaseCacheHandle<TCacheValue>> CreateCacheHandles<TCacheValue>(
        CacheManagerBase<TCacheValue> manager,
        ILoggerFactory loggerFactory,
        ICacheSerializer serializer)
    {
        ...
        {
            logger.LogInformation("Creating handle {0} of type {1}.", handleConfiguration.Name,
