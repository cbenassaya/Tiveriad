...
public interface ICache<TCacheValue> : IDisposable
{
    ...
    /// </exception>
    [SuppressMessage("Microsoft.Design", "CA1023:IndexersShouldNotBeMultidimensional", Justification = "nope")]
    ...
    /// <summary>
    ///     Returns a value indicating if the <paramref name="key" /> in <paramref name="region" /> exists in at least one
    ///     cache layer
    ...
    [SuppressMessage("Microsoft.Naming", "CA1716:IdentifiersShouldNotMatchKeywords", MessageId = "Get",
        Justification = "Maybe at some point.")]
