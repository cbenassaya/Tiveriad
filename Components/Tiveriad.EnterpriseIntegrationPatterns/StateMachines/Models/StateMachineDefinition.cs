    ...
    where TEvent : IComparable
{
    ...
    public PassiveStateMachine<TState, TEvent> CreatePassiveStateMachine(string name)
    {
        ...
        return new PassiveStateMachine<TState, TEvent>(stateMachine, stateContainer, stateDefinitions,
            initialState);
    }
    ...
    public ActiveStateMachine<TState, TEvent> CreateActiveStateMachine(string name)
    {
        ...
        return new ActiveStateMachine<TState, TEvent>(stateMachine, stateContainer, stateDefinitions,
            initialState);
    }
}