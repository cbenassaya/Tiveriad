    ...
    where TEvent : IComparable
{
    ...
    /// <param name="eventArgument">The event argument.</param>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    Task EventQueuedWithPriority(IStateMachineInformation<TState, TEvent> stateMachine, TEvent eventId,
    ...
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    Task EnteredInitialState(IStateMachineInformation<TState, TEvent> stateMachine, TState state,
