    ...
    where TEvent : IComparable
{
        ...
        TState initialState)
    {
        ...
        EnterInitialState(context, stateContainer, stateDefinitions, initialState);
    ...
    public void Fire(
        ...
        IStateDefinitionDictionary<TState, TEvent> stateDefinitions)
    {
        Fire(eventId, Missing.Value, stateContainer, stateDefinitions);
    }
        ...
        IStateDefinitionDictionary<TState, TEvent> stateDefinitions)
    {
        ...
        var currentState = stateContainer
            ...
            .Map(x => stateDefinitions[x])
            .ExtractOrThrow();
        var context = factory.CreateTransitionContext(currentState, new Missable<TEvent>(eventId), eventArgument, this);
        var result = stateLogic.Fire(currentState, context, stateContainer, stateDefinitions);
        ...
        OnTransitionCompleted(context, stateContainer.CurrentStateId.ExtractOrThrow());
    }
        ...
        TState initialStateId)
    {
        ...
        var newStateId = initializer.EnterInitialState(stateLogic, stateContainer, stateDefinitions);
        ...
        where T : EventArgs
    {
        ...
        {
            if (!raiseEventOnException) throw;
