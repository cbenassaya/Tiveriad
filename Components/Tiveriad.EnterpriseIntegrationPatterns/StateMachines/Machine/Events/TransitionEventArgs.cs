    ...
    where TEvent : IComparable
{
    ...
    public TState StateId => Context.StateDefinition.Id;

    /// <summary>
    ///     Gets the event id.
    /// </summary>
    /// <value>The event id.</value>
    public TEvent EventId => Context.EventId.Value;

    /// <summary>
    ///     Gets the event argument.
    /// </summary>
    /// <value>The event argument.</value>
    public object EventArgument => Context.EventArgument;
    ...
    {
        return string.Format(CultureInfo.InvariantCulture, "Transition from state {0} on event {1}.", StateId, EventId);
    }
}