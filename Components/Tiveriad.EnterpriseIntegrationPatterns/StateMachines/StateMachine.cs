    ...
    where TEvent : IComparable
{
        ...
        TState initialState)
    {
        ...
        await EnterInitialState(context, stateContainer, stateDefinitions, initialState)
            .ConfigureAwait(false);
        ...
        IStateDefinitionDictionary<TState, TEvent> stateDefinitions)
    {
        ...
        var result = await stateLogic.Fire(currentState, context, stateContainer, stateDefinitions)
            .ConfigureAwait(false);
        ...
        TState initialStateId)
    {
        ...
        var newStateId = await initializer.EnterInitialState(stateLogic, stateContainer, stateDefinitions)
            .ConfigureAwait(false);
