...
public static class ArgumentEscaper
{
    ...
    public static bool ShouldSurroundWithQuotes(string argument)
    {
    ...
    public static bool IsSurroundedWithQuotes(string argument)
    {
        return argument.StartsWith("\"", StringComparison.Ordinal) &&
               argument.EndsWith("\"", StringComparison.Ordinal);
    }

    public static bool ArgumentContainsWhitespace(string argument)
    {
