...
{
    internal sealed class ProblemDetailConverter : JsonConverter<ProblemDetail>
    {
        ...
        public override ProblemDetail Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, ProblemDetail value, JsonSerializerOptions options)
        {
        ...
        internal static void ReadValue(ref Utf8JsonReader reader, ProblemDetail value, JsonSerializerOptions options)
        {
        ...
        internal static void WriteProblemDetails(Utf8JsonWriter writer, ProblemDetail value, JsonSerializerOptions options)
        {
            if (value.Type != null)
