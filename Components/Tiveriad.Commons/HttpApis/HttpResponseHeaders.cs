...
public static class HttpResponseHeaders
{
    ...
    /// <summary>
    ///     Tells all caching mechanisms from server to client whether they may cache this object. It is measured in
    ///     seconds
    /// </summary>
    ...
    /// <summary>
    ///     This header is supposed to set P3P policy, in the form of P3P:CP=your_compact_policy. However, P3P did not
    ///     take off,[22] most browsers have never fully implemented it, a lot of websites set this header with fake policy
    ///     text, that was enough to fool browsers the existence of P3P policy and grant permissions for third party cookies.
    /// </summary>
    ...
    /// <summary>
    ///     Used in redirection, or when a new resource has been created. This refresh redirects after 5 seconds. This is
    ...
    /// <summary>
    ///     A HTTPS Policy informing the HTTP client how long to cache the HTTPS only policy and whether this applies to
    ///     subdomains.
    /// </summary>
