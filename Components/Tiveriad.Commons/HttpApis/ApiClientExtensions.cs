...
public static class ApiClientExtensions
{
    ...
    ///     <paramref name="apiClient" /> or <paramref name="builder" /> is
    ///     <see langword="null" />.
    /// </exception>
    ...
    /// <returns>The task object representing the asynchronous operation.</returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="apiClient" /> or <paramref name="requestMessage" /> is
    ///     <see langword="null" />.
    /// </exception>
    public static async Task<HttpResponseMessage> SendAsync(this IApiClient apiClient,
