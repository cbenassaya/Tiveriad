    ...
    where TBuilder : PostBuilder<TBuilder>
{
    ...
    /// <summary>
    ///     Appends the specified <paramref name="name" /> and <paramref name="value" /> to the form post body if the specified
    ...
    public TBuilder Content<TData>(TData data)
    {
        ...
        RequestMessage.Properties[ApiProperties.RequestContentData] = data;
