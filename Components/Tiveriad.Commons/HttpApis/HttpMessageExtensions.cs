...
public static class HttpMessageExtensions
{
    ...
    public static UrlBuilder GetUrlBuilder(this HttpRequestMessage requestMessage)
    {
        ...
        var propertyValue = requestMessage.Options.GetOrAdd(ApiProperties.RequestUrlBuilder, k =>
    ...
    public static void SetUrlBuilder(this HttpRequestMessage requestMessage, UrlBuilder urlBuilder)
    {
        ...
        requestMessage.Properties[ApiProperties.RequestUrlBuilder] = urlBuilder;
    }
    ...
    public static object? GetContentData(this HttpRequestMessage requestMessage)
    {
        ...
        requestMessage.Options.TryGetValue(ApiProperties.RequestContentData, out var propertyValue);
    ...
    public static void SetContentData(this HttpRequestMessage requestMessage, object contentData)
    {
        ...
        requestMessage.Properties[ApiProperties.RequestContentData] = contentData;
    }
    ...
    public static Dictionary<string, ICollection<string>> GetFormData(this HttpRequestMessage requestMessage)
    {
        ...
        var propertyValue = requestMessage.Options.GetOrAdd(ApiProperties.RequestFormData,
            k => new Dictionary<string, ICollection<string>>());
    ...
    public static HttpCompletionOption GetCompletionOption(this HttpRequestMessage requestMessage)
    {
        ...
        requestMessage.Options.TryGetValue(ApiProperties.HttpCompletionOption, out var propertyValue);
    ...
    /// <exception cref="ArgumentNullException"><paramref name="requestMessage" /> is <see langword="null" /></exception>
    public static void SetCompletionOption(this HttpRequestMessage requestMessage,
        HttpCompletionOption completionOption)
    {
        if (requestMessage == null)
            throw new ArgumentNullException(nameof(requestMessage));

        requestMessage.Properties[ApiProperties.HttpCompletionOption] = completionOption;
    }
    ...
    public static CancellationToken GetCancellationToken(this HttpRequestMessage requestMessage)
    {
        ...
        requestMessage.Options.TryGetValue(ApiProperties.CancellationToken, out var propertyValue);
    ...
    public static void SetCancellationToken(this HttpRequestMessage requestMessage, CancellationToken cancellationToken)
    {
        ...
        requestMessage.Properties[ApiProperties.CancellationToken] = cancellationToken;
    }
    ...
    public static IContentSerializer GetContentSerializer(this HttpRequestMessage requestMessage)
    {
        ...
        var propertyValue =
            requestMessage.Options.GetOrAdd(ApiProperties.ContentSerializer, k => ContentSerializer.Current);
    ...
    /// </param>
    /// <exception cref="ArgumentNullException"><paramref name="requestMessage" /> is <see langword="null" /></exception>
    public static void SetContentSerializer(this HttpRequestMessage requestMessage,
        IContentSerializer contentSerializer)
    {
        if (requestMessage == null)
            throw new ArgumentNullException(nameof(requestMessage));

        requestMessage.Properties[ApiProperties.ContentSerializer] = contentSerializer ?? ContentSerializer.Current;
    }
    ...
    public static async Task<TData> DeserializeAsync<TData>(this HttpResponseMessage responseMessage,
    ...
    public static async Task EnsureSuccessStatusCode(this HttpResponseMessage responseMessage, bool includeContent)
    {
        ...
        var message =
            $"Response status code does not indicate success: {responseMessage.StatusCode} ({responseMessage.ReasonPhrase});";
    ...
    private static async Task CheckResponseForProblem(HttpResponseMessage responseMessage)
    {
        ...
        if (!string.Equals(mediaType, ProblemDetail.ContentType, StringComparison.OrdinalIgnoreCase))
            return;

        var serializer = responseMessage.RequestMessage.GetContentSerializer();

        var problem = await serializer
            .DeserializeAsync<ProblemDetail>(responseMessage.Content)
            .ConfigureAwait(false);
