...
namespace Tiveriad.Commons.HttpApis
{
    ...
    public static class HttpMessageExtensions
    {
        ...
        public static Dictionary<string, ICollection<string>> GetFormData(this HttpRequestMessage requestMessage)
        {
            ...
            var propertyValue = requestMessage.Options.GetOrAdd(ApiProperties.RequestFormData, k => new Dictionary<string, ICollection<string>>());
        ...
        public static IContentSerializer GetContentSerializer(this HttpRequestMessage requestMessage)
        {
            ...
            var propertyValue = requestMessage.Options.GetOrAdd(ApiProperties.ContentSerializer, k => ContentSerializer.Current);
