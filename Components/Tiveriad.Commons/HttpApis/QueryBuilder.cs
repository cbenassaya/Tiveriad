    ...
    where TBuilder : QueryBuilder<TBuilder>
{
    ...
    /// <summary>
    ///     Sets HTTP header with the specified <paramref name="name" /> and <paramref name="value" /> if the specified
    ...
    /// <summary>
    ///     Appends the specified <paramref name="name" /> and <paramref name="value" /> to the request Uri if the specified
    ///     <paramref name="condition" /> is true.
    /// </summary>
