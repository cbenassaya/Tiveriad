...
{
    public ScribanTemplateRenderer(ITemplateManager templateManager, ScribanTemplateRendererConfiguration rendererConfiguration) : base(templateManager, rendererConfiguration) { }
