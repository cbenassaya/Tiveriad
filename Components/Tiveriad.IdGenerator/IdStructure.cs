...
/// <summary>
    /// Specifies the number of bits to use for the different parts of an Id for an <see cref="LongIdGenerator"/>.
    /// </summary>
    public class IdStructure
    {
        ...
        /// <summary>
        /// Initializes an <see cref="IdStructure"/> for <see cref="LongIdGenerator"/>s.
        /// </summary>
        ...
        /// </summary>
        /// <param name="epoch">The used epoch for the <see cref="LongIdGenerator"/> to use as offset.</param>'
        /// <param name="timeSource">The used <see cref="ITimeSource"/> for the <see cref="LongIdGenerator"/>.</param>
