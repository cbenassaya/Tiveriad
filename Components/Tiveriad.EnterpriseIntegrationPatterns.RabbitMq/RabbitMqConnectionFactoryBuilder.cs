...
public class RabbitMqConnectionFactoryBuilder : IConnectionFactoryBuilder<RabbitMqConnectionConfigurator,
    IRabbitMqConnectionConfiguration, IConnection>
{
    private RabbitMqConnectionConfigurator _configurator;
    private ILogger<RabbitMqConnectionFactoryBuilder> _logger;

    public IConnectionFactoryBuilder<RabbitMqConnectionConfigurator, IRabbitMqConnectionConfiguration, IConnection>
        Configure(Action<RabbitMqConnectionConfigurator> action)
    {
