...
public class ActivityController : IActivityController
{
    ...
    public ActivityController(ISubscriptionRepository subscriptionRepository, IWorkflowController workflowController,
    ...
    public async Task<PendingActivity> GetPendingActivity(string activityName, string workerId,
        TimeSpan? timeout = null)
    {
        ...
        while ((subscription == null && _dateTimeProvider.UtcNow < endTime) || firstPass)
        {
            ...
            subscription =
                await _subscriptionRepository.GetFirstOpenSubscription(Event.EventTypeActivity, activityName,
        ...
        try
        {
            ...
            if (!await _subscriptionRepository.SetSubscriptionToken(subscription.Id, result.Token, workerId,
                    result.TokenExpiry))
                return null;
