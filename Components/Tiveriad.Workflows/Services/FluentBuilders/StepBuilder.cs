    ...
    where TStepBody : IStepBody
{
        ...
        where TStep : IStepBody
    {
        ...
        if (stepSetup != null) stepSetup.Invoke(stepBuilder);
    ...
    public IStepBuilder<TData, TStepBody> Branch<TStep>(object outcomeValue, IStepBuilder<TData, TStep> branch)
        where TStep : IStepBody
    {
    ...
    public IStepBuilder<TData, TStepBody> Branch<TStep>(Expression<Func<TData, object, bool>> outcomeExpression,
    ...
    public IStepBuilder<TData, TStepBody> Input<TInput>(Expression<Func<TStepBody, TInput>> stepProperty,
    ...
    public IStepBuilder<TData, TStepBody> Output<TOutput>(Expression<Func<TData, TOutput>> dataProperty,
        ...
        Expression<Func<TData, DateTime>> effectiveDate = null, Expression<Func<TData, bool>> cancelCondition = null)
    {
        ...
        if (effectiveDate != null) stepBuilder.Input(step => step.EffectiveDate, effectiveDate);
    ...
    public IStepBuilder<TData, TStep> End<TStep>(string name) where TStep : IStepBody
    {
        ...
        if (ancestor == null) throw new InvalidOperationException($"Parent step of name {name} not found");
    ...
    public IStepBuilder<TData, TStepBody> CompensateWith<TStep>(Action<IStepBuilder<TData, TStep>> stepSetup = null)
        where TStep : IStepBody
    {
        var newStep = new WorkflowStep<TStep>();
        WorkflowBuilder.AddStep(newStep);
    ...
    public IStepBuilder<TData, Activity> Activity(string activityName,
        Expression<Func<TData, object>> parameters = null, Expression<Func<TData, DateTime>> effectiveDate = null,
    ...
    public IStepBuilder<TData, Activity> Activity(Expression<Func<TData, IStepExecutionContext, string>> activityName,
        Expression<Func<TData, object>> parameters = null, Expression<Func<TData, DateTime>> effectiveDate = null,
        Expression<Func<TData, bool>> cancelCondition = null)
    {
        var newStep = new WorkflowStep<Activity>();
